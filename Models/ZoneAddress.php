...
class ZoneAddress extends Model implements iModelExport {
    use SoftDeletes;

    static protected $_table = 'com_zeapps_contact_zone_address';
    protected $table ;
    ...
    public function getModelExport() : ModelExportType {
        ...
        $objModelExport->tableLabel = "Zone d'adresse" ;
